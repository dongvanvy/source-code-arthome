...
namespace APIFORMOBILEAPPWORKING.Controllers
{
    public class BillDetailController : ApiController
    {
        ...
        [ResponseType(typeof(tbl_billDetail))]
        public IHttpActionResult Gettbl_billDetail(string id,double barcode)
        {
            tbl_billDetail tbl_billDetail = db.tbl_billDetail.SingleOrDefault(n=>n.Bill_id==id && n.sku_barcode==barcode);
        ...
        public IHttpActionResult Puttbl_billDetail(string id, double barcode, tbl_billDetail tbl_billDetail)
        {
            ...
            if (id != tbl_billDetail.Bill_id && barcode!=tbl_billDetail.sku_barcode)
            {
                return BadRequest();
            }
        ...
        [ResponseType(typeof(tbl_billDetail))]
        public IHttpActionResult Deletetbl_billDetail(string id,double barcode)
        {
            tbl_billDetail tbl_billDetail = db.tbl_billDetail.SingleOrDefault(n=>n.Bill_id==id && n.sku_barcode==barcode);
            if (tbl_billDetail == null)
            {
