...
namespace WEBREPORTMOBILEAPP.Models
{
    ...
    public partial class DBMOBILEAPPBAEntities : DbContext
    {
        public DBMOBILEAPPBAEntities()
            : base("name=DBMOBILEAPPBAEntities")
        {
        }
        ...
        public virtual DbSet<VW_KHTIEPCAN> VW_KHTIEPCAN { get; set; }
